public class BSTree<T extends Comparable<? super T>> {
    ...
    private Node search(T toSearch, Node<T> current) { // Método iterativo
        do {
    ...
    private Node searchR(T toSearch, Node<T> current) { // Método recursivo
    ...
    public T predecessor(T key) {
        Node<T> n = search(key, root);
        Node<T> pre = (n == null) ? null : predecessor(n);
    ...
    public T successor(T key) {
        Node<T> n = search(key, root);
        Node<T> suc = (n == null) ? null : successor(n);
